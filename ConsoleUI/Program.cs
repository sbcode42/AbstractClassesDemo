    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Motorcycle motorcycle = new Motorcycle() { HasSideCart = true, Make = "Ducati", Model = "Cruiser", Year = 2018 };
            Vehicle sedan = new Car() { Make = "Dodge", Model = "Charger", Year = 1996 };
            Vehicle sport = new Car() { HasTrunk = false, Make = "Ford", Model = "Mustang", Year = 2011 };
